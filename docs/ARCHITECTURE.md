...
- Canonical sidebar order, top to bottom: Project Builder, Projects, Tasks, Knowledge, Focus and Accountability, Settings. A global command bar sits above the sidebar and owns Capture. Knowledge is the Learn pillar surface, where the user browses the Knowledge base and works the candidate review queue that approves or rejects Dreaming candidates before they become durable. Focus and Accountability is the decide layer and ships later, shown as a placeholder until Surface lands.
- Settings sub tabs, in order: Account, Integrations, Models, Memory, Appearance, Data and Privacy. Memory holds the Dreaming schedule, retention, and scope controls for what consolidation may consider.
